...
const (
	TunnelService_Connect_FullMethodName = "/proto.TunnelService/Connect"
)
...
type TunnelServiceClient interface {
	Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelPacket, TunnelPacket], error)
}
...
func (c *tunnelServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelPacket, TunnelPacket], error) {
...
type TunnelService_ConnectClient = grpc.BidiStreamingClient[TunnelPacket, TunnelPacket]

// TunnelServiceServer is the server API for TunnelService service.
// All implementations must embed UnimplementedTunnelServiceServer
// for forward compatibility.
type TunnelServiceServer interface {
	Connect(grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]) error
...
func (UnimplementedTunnelServiceServer) Connect(grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]) error {
...
func _TunnelService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).Connect(&grpc.GenericServerStream[TunnelPacket, TunnelPacket]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_ConnectServer = grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]
